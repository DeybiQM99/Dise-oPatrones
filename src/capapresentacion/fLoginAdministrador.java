 ...
 * @author carlo
 */
public class fLoginAdministrador extends javax.swing.JInternalFrame {
    ...
    private void abrirfmCategoria(Empleado emp) {
        fmCategoria ventana = new fmCategoria(emp);
