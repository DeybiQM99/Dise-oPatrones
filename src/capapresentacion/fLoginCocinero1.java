 ...
 * @author carlo
 */
public class fLoginCocinero1 extends javax.swing.JInternalFrame {
    ...
    public fLoginCocinero1() {
        ...
        if(emp != null && emp.getIdTipoUsuario() == 4 || emp.getIdTipoUsuario() == 1  ) { // 2 = Cajera
    ...
    private void abrirpedido(Empleado emp) {
        fmDetallePedido ventana = new fmDetallePedido(emp);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("login-cocinero");
