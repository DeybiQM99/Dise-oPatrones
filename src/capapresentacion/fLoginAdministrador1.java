 ...
 * @author carlo
 */
public class fLoginAdministrador1 extends javax.swing.JInternalFrame {
    ...
    private void abrirEmpleado(Empleado emp) {
        fmEmpleado ventana = new fmEmpleado(emp);
