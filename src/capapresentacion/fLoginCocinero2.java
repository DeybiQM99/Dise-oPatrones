 ...
 * @author carlo
 */
public class fLoginCocinero2 extends javax.swing.JInternalFrame {
    ...
    private void abrirproducto(Empleado emp) {
        fmProducto ventana = new fmProducto(emp);
